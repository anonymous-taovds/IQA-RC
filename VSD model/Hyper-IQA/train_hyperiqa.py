...
def main(config):
    ...
    folder_path = {
        ...
        'tid2013': '/mnt/disk10T/fqy/hyperIQA-master/tid2013/',
        'kadid_10k': '/mnt/disk10T/fqy/dataset/kadid10k/',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', dest='dataset', type=str, default='kadid_10k', help='Support datasets: livec|koniq-10k|bid|live|csiq|tid2013|kadid-10k')
    ...
    parser.add_argument('--epochs', dest='epochs', type=int, default=500, help='Epochs for training')
